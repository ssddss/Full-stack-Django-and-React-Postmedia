...
SECRET_KEY = os.environ.get('SECRET_KEY', default='django-insecure-39u^q^ybi+kum8uc=8%v1uogkm(qf^jp#i&da%ekv4=rhyu0x$')
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': os.getenv("DATABASE_PASSWORD",'de1234'),
